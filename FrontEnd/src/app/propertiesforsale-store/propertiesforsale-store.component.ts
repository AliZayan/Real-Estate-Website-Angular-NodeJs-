...
@Component({
  selector: 'app-propertiesforsale-store',
  templateUrl: './propertiesforsale-store.component.html',
  styleUrls: ['./propertiesforsale-store.component.css']
})
export class PropertiesforsaleStoreComponent implements OnInit {
  ads: any = [];
  cities;
  selectedCity;
  regions;
  ...
  ngOnInit(): void {
    ...
    this.Addadvertisment.getadsStore().subscribe((data) => {
      console.log(data);
      this.ads = data;
      console.log("ahmed");
