...
@Component({
  selector: 'app-propertiesforsale-villa',
  templateUrl: './propertiesforsale-villa.component.html',
  styleUrls: ['./propertiesforsale-villa.component.css']
})
export class PropertiesforsaleVillaComponent implements OnInit {
  ads: any = [];
  cities;
  selectedCity;
  regions;
  ...
  ngOnInit(): void {
    ...
    this.Addadvertisment.getadsVilla().subscribe((data) => {
      console.log(data);
      this.ads = data;
      console.log("ahmed");
