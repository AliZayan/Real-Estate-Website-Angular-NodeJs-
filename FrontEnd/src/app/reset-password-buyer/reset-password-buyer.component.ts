...
@Component({
  selector: 'app-reset-password-buyer',
  templateUrl: './reset-password-buyer.component.html',
  styleUrls: ['./reset-password-buyer.component.css']
})
export class ResetPasswordBuyerComponent implements OnInit {
  message: string;
  err: string;
  myGroup;
  token
