...
@Component({
  selector: 'app-propertiesforsale-office',
  templateUrl: './propertiesforsale-office.component.html',
  styleUrls: ['./propertiesforsale-office.component.css']
})
export class PropertiesforsaleOfficeComponent implements OnInit {
  ads: any = [];
  cities;
  selectedCity;
  regions;
  ...
  ngOnInit(): void {
    ...
    this.Addadvertisment.getadsOffice().subscribe((data) => {
      console.log(data);
      this.ads = data;
      console.log("ahmed");
