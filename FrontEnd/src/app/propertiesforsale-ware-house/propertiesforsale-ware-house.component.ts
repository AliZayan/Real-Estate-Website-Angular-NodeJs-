...
@Component({
  selector: 'app-propertiesforsale-ware-house',
  templateUrl: './propertiesforsale-ware-house.component.html',
  styleUrls: ['./propertiesforsale-ware-house.component.css']
})
export class PropertiesforsaleWareHouseComponent implements OnInit {
  ads: any = [];
  cities;
  selectedCity;
  regions;
  ...
  ngOnInit(): void {
    ...
    this.Addadvertisment.getadsWareHouse().subscribe((data) => {
      console.log(data);
      this.ads = data;
      console.log("ahmed");
