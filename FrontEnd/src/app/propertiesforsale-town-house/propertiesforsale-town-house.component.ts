...
@Component({
  selector: 'app-propertiesforsale-town-house',
  templateUrl: './propertiesforsale-town-house.component.html',
  styleUrls: ['./propertiesforsale-town-house.component.css']
})
export class PropertiesforsaleTownHouseComponent implements OnInit {
  ads: any = [];
  cities;
  selectedCity;
  regions;
  ...
  ngOnInit(): void {
    ...
    this.Addadvertisment.getadsTownHouse().subscribe((data) => {
      console.log(data);
      this.ads = data;
      console.log("ahmed");
